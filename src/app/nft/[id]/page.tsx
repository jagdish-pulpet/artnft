...
const MOCK_NFT_DATA = {
  id: nft_id_002, // Using Pixel Pal for auction demo
  name: 'Pixel Pal',
  ...
  isAuction: true,
  startingBid: '0.2 ETH',
  buyNowPrice: '1.0 ETH', // Can have buy now even if auction
  highestBid: '0.3 ETH', // From schema.sql mock bids
  auctionEndTime: new Date(Date.now() + 3 * 24 * 60 * 60 * 1000).toISOString(), // Approx 3 days from now
  bids: [
    { id: 'bid_mock1', user: 'NFTCollectorGal', amount: '0.3 ETH', time: '10 mins ago' }, // User 3
    { id: 'bid_mock2', user: 'CryptoGallery', amount: '0.25 ETH', time: '1 hour ago' }, // User 4
  ],
};
...
export default function NFTDetailsPage() {
  ...
  // const id = routeParams.id; // Use this 'id' to fetch actual data in the future
  // For now, MOCK_NFT_DATA is static. To make it dynamic based on URL, you'd fetch the NFT with `routeParams.id`
  // and then set `nft` state. For this exercise, we'll stick to the single MOCK_NFT_DATA.
  const nft = MOCK_NFT_DATA; // This will always show Pixel Pal for now.
