    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-rainbow-swirl text-primary-foreground p-4 overflow-hidden relative">
      ...
      <div className="text-center space-y-8 relative z-10"> {/* Ensure content is above ripples */}
        <div className="absolute -top-16 -left-16 opacity-30">
          <Sparkles className="h-32 w-32 text-primary-foreground/70 animate-pulse" />
        </div>
        <div className="absolute -bottom-16 -right-16 opacity-30">
          <Sparkles className="h-32 w-32 text-primary-foreground/70 animate-pulse delay-500" />
        </div>
        
        <div className="relative z-10">
          <ArtNFTLogo size="large" className="text-primary-foreground animate-pulse-slow mb-4" />
        ...
        <div className="w-full max-w-xs md:max-w-sm space-y-3 relative z-10">
          {!isLoadingComplete ? (
            ...
            <Loader2 className="h-8 w-8 text-primary-foreground animate-spin mx-auto" />
          )}
        </div>
      </div>
      <style jsx global>{`
