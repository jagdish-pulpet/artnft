...
import { ChevronLeft, Frown, Palette, Camera, Music2, ToyBrick, Globe, Bitcoin, Sparkles as SparklesIcon, Grid as GridIcon } from 'lucide-react'; // Renamed Grid and Sparkles
...
export default function CategoryPage() {
  ...
  const categoryData = categorySpecificNFTs[slug]; // Use categoryData to avoid conflict with category variable in map
