...
const transactionTypeColors: Record<TransactionType, string> = {
    purchase: 'text-red-500', // Expense
    sale: 'text-green-500', // Income
    mint: 'text-blue-500', // Creation
    bid_placed: 'text-orange-500', // Potential expense
    bid_received: 'text-purple-500', // Potential income
};
...
interface Transaction {
  ...
  item: string;
  itemId?: string; // Link to NFT
  amount: string; // e.g., "+ 1.5 ETH" or "- 0.2 ETH"
  date: string;
  ...
  return (
    <AppLayout>
      <div className="max-w-6xl mx-auto p-0 md:p-4 space-y-6 md:space-y-8">
        ...
        {/* Platform Updates / Admin Announcements */}
        ...
        {/* Tabs for NFTs, Favorites, Transactions, Activity */}
