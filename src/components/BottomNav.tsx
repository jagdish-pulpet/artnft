...
export default function BottomNav() {
  ...
  return (
    <nav className={cn(
        ...
        // The class "translate-y-0" is now implicitly always active, ensuring visibility.
        // Removed: "transition-transform duration-300 ease-in-out",
        // Removed: isNavVisible ? 'translate-y-0' : 'translate-y-full'
      )}>
